...
For a change that threatens the plan itself, run `bmad-correct-course` first. It needs a PRD and user-described affected work. For standalone spec work without a PRD, use `bmad-spec` update.
